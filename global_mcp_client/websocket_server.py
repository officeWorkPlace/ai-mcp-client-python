"""
WebSocket server wrapper for Global MCP Client
Enables UI communication via WebSocket while maintaining MCP server connections via stdio
"""
...
class MCPWebSocketServer:
    """
    WebSocket server that wraps the Global MCP Client
    Architecture: UI <-WebSocket-> MCPWebSocketServer <-stdio-> MCP Servers
    """
